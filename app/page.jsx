...
const ITEMS = [
  {
    ...
    price: UNIT_PRICE,
    icon: CookingPot,
    materials: { Milho: 1, "Sal Refinado": 0.25, Manteiga: 0.25, Água: 0.25 },
  },
  {
    id: "shot-tequila",
    ...
    price: UNIT_PRICE,
    icon: Wine,
    materials: { "Sal Refinado": 0.25, "Água Filtrada": 0.25, "Fermento Alcoólico": 0.25, Agave: 0.25 },
  },
  {
    id: "bolinho-bacalhau",
    ...
    materials: { Tempero: 0.25, Batata: 0.25, Bacalhau: 0.25, Ovo: 0.25 },
  },
  {
    id: "suco-laranja",
    ...
    price: UNIT_PRICE,
    icon: GlassWater,
    materials: { "Água Filtrada": 0.25, Laranjas: 1, Açúcar: 0.25, Gelo: 0.25 },
  },
  {
    id: "cerveja",
    name: "Cerveja",
    price: UNIT_PRICE,
    icon: Beer,
    materials: { Água: 0.25, Lúpulo: 0.25, Cevada: 0.25, "Fermento Alcoólico": 0.25 },
  },
  {
    id: "espetinho",
    name: "Espetinho",
    price: UNIT_PRICE,
    icon: ShoppingBasket,
    materials: { Carvão: 0.25, "Carne Crua": 1, "Tempero Simples": 0.25, "Sal Grosso": 0.25 },
  },
];
